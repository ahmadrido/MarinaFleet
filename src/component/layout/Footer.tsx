        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-blue-600 ">
                ...
                <i className="fa-solid fa-ship text-3xl mr-3"></i>
                Marina Fleet</h1>
              </div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      className="group flex justify-center items-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                      href="#"
                    >
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2025 Marina Fleet</p>
            </div>
          </div>
        </div>
      </footer>
